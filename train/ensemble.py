...
if __name__ == "__main__":
    ...
    models_and_weights = load_models_and_weights(path_output, model_prefix)
    ...
    submission_output_path = os.path.join(path_output, 'Leaderboard_set_Submission_form_ensemble.csv')
